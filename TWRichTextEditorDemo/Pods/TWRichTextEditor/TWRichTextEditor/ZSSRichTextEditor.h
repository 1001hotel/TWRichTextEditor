...
static NSString * const ZSSRichTextEditorToolbarVoice = @"com.zedsaid.toolbaritem.voice";
static NSString * const ZSSRichTextEditorToolbarSelect = @"com.zedsaid.toolbaritem.select";
static NSString * const ZSSRichTextEditorToolbarTextStyle = @"com.zedsaid.toolbaritem.textstyle";
static NSString * const ZSSRichTextEditorToolbarTextSize = @"com.zedsaid.toolbaritem.textsize";
static NSString * const ZSSRichTextEditorToolbarTextAlignment = @"com.zedsaid.toolbaritem.textalignment";
